...
echo %1
python C:/Users/mchiu/OneDrive/mch/Work/TheCompany/Development/src/python/mch/Lib/PipelineManager/PipelineManager.py --config_folder="./config/" --config_file="task_3.json"
